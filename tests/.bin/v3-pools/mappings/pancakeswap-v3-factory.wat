(module
  ...
  (func $~lib/@graphprotocol/graph-ts/common/collections/ByteArray.fromI32 (type 0) (param i32) (result i32)
    ...
    call $~lib/typedarray/Uint8Array#__set
    local.get 1)
  (func $start:tests/v3-pools/mappings/pancakeswap-v3-factory.test~anonymous|0~anonymous|0 (type 4)
  ...
  (func $start:tests/v3-pools/mappings/pancakeswap-v3-factory.test~anonymous|0~anonymous|1 (type 4)
    (local i32 i32)
    i32.const 0
    global.set $~argumentsLength
    ...
    i32.const 2464
    call $~lib/matchstick-as/assert/assert.fieldEquals)
  (func $start:tests/v3-pools/mappings/pancakeswap-v3-factory.test~anonymous|0~anonymous|2 (type 4)
    (local i32 i32)
    i32.const 0
    global.set $~argumentsLength
    call $tests/event-creators/createPoolCreatedEvent@varargs
    ...
    i32.const 2464
    call $~lib/matchstick-as/assert/assert.fieldEquals)
  (func $start:tests/v3-pools/mappings/pancakeswap-v3-factory.test~anonymous|0 (type 4)
    i32.const 2624
    i32.load
    i32.const 2656
  ...
  (elem $0 (i32.const 1) func $start:tests/v3-pools/mappings/pancakeswap-v3-factory.test~anonymous|0~anonymous|0 $~lib/@graphprotocol/graph-ts/common/value/Value#displayData~anonymous|0 $start:tests/v3-pools/mappings/pancakeswap-v3-factory.test~anonymous|0~anonymous|1 $start:tests/v3-pools/mappings/pancakeswap-v3-factory.test~anonymous|0~anonymous|2 $start:tests/v3-pools/mappings/pancakeswap-v3-factory.test~anonymous|0)
