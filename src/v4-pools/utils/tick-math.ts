...
export abstract class TickMath {
  public static MIN_POOL_TICK: number = -887272;
  public static MAX_POOL_TICK: number = -TickMath.MIN_POOL_TICK;
  public static MIN_POOL_SQRT_RATIO: BigInt = BigInt.fromString("4295128739");
  public static MAX_POOL_SQRT_RATIO: BigInt = BigInt.fromString("1461446703485210103287273052203988822378723970342");
  ...
  public static getSqrtRatioAtTick(tick: i32): BigInt {
    if (tick < TickMath.MIN_POOL_TICK || tick > TickMath.MAX_POOL_TICK) {
