...
import { Initialize as InitializeEvent } from "../../../../../../generated/templates/PancakeSwapV3Pool/PancakeSwapV3Pool";
import { handleV3PoolInitialize } from "../../v3-pool-initialize";

export function handlePancakeSwapV3PoolInitialize(event: InitializeEvent): void {
