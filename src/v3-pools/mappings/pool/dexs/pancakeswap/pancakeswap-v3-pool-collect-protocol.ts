...
import { CollectProtocol } from "../../../../../../generated/templates/PancakeSwapV3Pool/PancakeSwapV3Pool";
import { handleV3PoolProtocolCollect } from "../../v3-pool-protocol-collect";

export function handlePancakeSwapV3PoolCollectProtocol(event: CollectProtocol): void {
