...
import { Initialize as InitializeEvent } from "../../../../../../generated/templates/RamsesV3Pool/RamsesV3Pool";
import { handleV3PoolInitialize } from "../../v3-pool-initialize";

export function handleRamsesV3PoolInitialize(event: InitializeEvent): void {
