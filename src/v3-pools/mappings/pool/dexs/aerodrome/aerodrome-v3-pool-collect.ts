...
import { Collect as CollectEvent } from "../../../../../../generated/templates/AerodromeV3Pool/AerodromeV3Pool";
import { handleV3PoolCollect } from "../../v3-pool-collect";

export function handleAerodromeV3PoolCollect(event: CollectEvent): void {
