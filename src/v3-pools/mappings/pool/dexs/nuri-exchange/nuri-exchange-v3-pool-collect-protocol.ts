...
import { CollectProtocol as CollectProtocolEvent } from "../../../../../../generated/templates/NuriExchangeV3Pool/NuriExchangeV3Pool";
import { handleV3PoolProtocolCollect } from "../../v3-pool-protocol-collect";

export function handleNuriExchangeV3PoolCollectProtocol(event: CollectProtocolEvent): void {
